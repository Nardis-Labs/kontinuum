...
import (
	...
	"lab.nardis.io/kontinuum/internal/controller"
...
func init() {
	...
	utilruntime.Must(kontinuumv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "96bbdc1b.nardis.io",
	...
	if err = (&controller.HubClusterReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "HubCluster")
		os.Exit(1)
	}
